...
export const actions = [
  {
    ...
    priority: 95,
    urgent: true,
    when: { anyFlag: ['presion', 'posible_despido', 'despido', 'firma_proxima', 'reunion_proxima'] },
  },
  {
    id: 'no_entregar_datos',
    label: 'No entregues resultados ni autorices su difusión sin orientación',
    detail: 'Puedes pedir por escrito la finalidad antes de responder a la solicitud.',
    priority: 92,
    urgent: true,
    when: { anyFlag: ['solicitud_prueba', 'solicitud_revelar', 'solicitud_historia', 'insisten'] },
  },
  {
    ...
    priority: 90,
    when: { anyFlag: ['despido', 'posible_despido', 'motivo_verbal', 'sin_motivo'] },
  },
  {
    id: 'guardar_despido',
  ...
  },
  {
    ...
    priority: 82,
    when: { anyFlag: ['divulgacion', 'divulgacion_publica', 'solicitud_datos', 'solicitud_prueba', 'solicitud_revelar', 'solicitud_historia'] },
  },
  {
    id: 'guardar_mensajes',
    ...
    priority: 70,
    when: { anyFlag: ['presion', 'comentarios', 'amenaza', 'divulgacion', 'cambio_funciones', 'cambio_trato', 'cambio_evaluaciones'] },
  },
  {
    id: 'consultar_salud',
    ...
    priority: 65,
    when: { anyFlag: ['salud', 'necesita_permisos', 'tareas_dificiles'] },
  },
  {
    id: 'ordenar_fechas',
